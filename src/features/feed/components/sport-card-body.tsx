...
export type SportCardBodyProps = {
...
// Rings + sessions/week list, shared by the feed's sport card and the
// send-like hero. content.trainingFrequency (overall) and sportIcon are
// deliberately not rendered — neither appears in the mockups (README note).
export function SportCardBody({ content }: SportCardBodyProps) {
  return (
